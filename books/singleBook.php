<?php
    ...
    $sql = "SELECT books.`_id` as bookID, `title`, `description`, `year`, authors.name as author_name FROM `books` INNER JOIN authors ON books.author_id = authors._id WHERE books._id = $bookID";
